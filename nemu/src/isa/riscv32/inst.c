...
// #define ECALL(dnpc) isa_raise_intr(word_t NO, vaddr_t epc)
...
INSTPAT("0000000 00000 00000 000 00000 11100 11", ecall  , I, cpu.csrs.mepc=s->pc;cpu.csrs.mcause = R(17);printf("%08x : 写入异常号 ： %08x,dnpc : %08x \n",s->pc,cpu.csrs.mcause,cpu.csrs.mtvec);s->dnpc = cpu.csrs.mtvec);

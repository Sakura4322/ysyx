...
INSTPAT("0000000 ????? ????? 101 ????? 00100 11", srli   , I, R(rd) = (uint32_t)src1 >> SEXT(imm, 5)); // logic move
...
INSTPAT("0000001 ????? ????? 110 ????? 01100 11", rem, R, R(rd) = (int32_t)src2 != 0 ? (int32_t)src1 % (int32_t)src2 : (int32_t)src1);

...
INSTPAT("0011000 00010 00000 000 00000 11100 11", mret , R, s->dnpc = cpu.csrs.mepc+4);
INSTPAT("0000000 00000 00000 000 00000 11100 11", ecall  , I, ECALL(s->pc);/*printf("%08x : 写入异常号 : %08x,dnpc : %08x \n",s->pc,cpu.csrs.mcause,cpu.csrs.mtvec)*/);

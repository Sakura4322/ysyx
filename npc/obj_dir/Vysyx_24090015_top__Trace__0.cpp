...
void Vysyx_24090015_top___024root__trace_chg_sub_0(Vysyx_24090015_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        bufp->chgCData(oldp+11,(((0U == (0xfffU & vlSelf->ysyx_24090015_top__DOT__imm))
                                  ? 2U : ((0x300U == 
                                           (0xfffU 
                                                   ...
                                                   ((0x305U 
                                                    ...
                                                    ((0x341U 
                                                     ...
                                                     ((0x342U 
                                                       ...
                                                       ? 3U
                                                       : 0U))))))),2);
        bufp->chgCData(oldp+12,(((0U == (0xfffU & vlSelf->ysyx_24090015_top__DOT__imm))
                                  ? 3U : 0U)),2);
        bufp->chgCData(oldp+13,(vlSelf->ysyx_24090015_top__DOT__csr_regfiles_instance__DOT__csr_raddr0),2);
        bufp->chgBit(oldp+14,(((0U == (0xfffU & vlSelf->ysyx_24090015_top__DOT__imm)) 
                               | ((0x300U == (0xfffU 
                                              & vlSelf->ysyx_24090015_top__DOT__imm)) 
                                  | ((0x302U != (0xfffU 
                                                 & vlSelf->ysyx_24090015_top__DOT__imm)) 
                                     & ((0x305U == 
                                        ...
                                        | ((0x341U 
                                           ...
                                           | (0x342U 
                                              == (0xfffU 
                                                  & vlSelf->ysyx_24090015_top__DOT__imm)))))))));
        bufp->chgBit(oldp+15,((0U == (0xfffU & vlSelf->ysyx_24090015_top__DOT__imm))));
        bufp->chgCData(oldp+16,(vlSelf->ysyx_24090015_top__DOT__idu0__DOT__inst_type),4);
        bufp->chgIData(oldp+17,(vlSelf->ysyx_24090015_top__DOT__idu0__DOT__temp_immI),32);
        bufp->chgCData(oldp+18,(vlSelf->ysyx_24090015_top__DOT__idu0__DOT__t0__DOT__opcode),7);
    }
    if (VL_UNLIKELY((vlSelf->__Vm_traceActivity[1U] 

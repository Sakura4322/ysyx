...
void Vysyx_24090015_top___024root__trace_chg_sub_0(Vysyx_24090015_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgIData(oldp+45,((vlSelf->pc << 2U)),32);
    bufp->chgIData(oldp+46,(((IData)(4U) + (vlSelf->pc 
                                            << 2U))),32);
    bufp->chgIData(oldp+47,(vlSelf->ysyx_24090015_top__DOT__npc_dnpc),32);
    ...
    bufp->chgIData(oldp+55,(((0x80000U & (vlSelf->inst 
                                          >> 0xcU)) 

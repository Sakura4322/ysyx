...
void Vysyx_24090015_top___024root__trace_chg_sub_0(Vysyx_24090015_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgIData(oldp+54,(vlSelf->inst),32);
    bufp->chgIData(oldp+55,(vlSelf->pc),32);
    bufp->chgIData(oldp+56,(vlSelf->dnpc),32);
    bufp->chgBit(oldp+57,(vlSelf->flag));
    bufp->chgBit(oldp+58,(vlSelf->hit_good_or_bad));
    bufp->chgIData(oldp+59,(((IData)(4U) + vlSelf->pc)),32);
                                          ...
                                          | ((0x800U 
                                             ...
                                             | ((0x7e0U 
                                                ...
                                                | (0x1eU 
                                                   & (vlSelf->inst 
                                                      >> 7U))))))),32);
    bufp->chgSData(oldp+62,((vlSelf->inst >> 0x14U)),12);
    bufp->chgIData(oldp+63,(((0x100000U & (vlSelf->inst 
                                           >> 0xbU)) 
                             | ((0xff000U & vlSelf->inst) 
                                | ((0x800U & (vlSelf->inst 
                                   ...
                                   | (0x7feU & (vlSelf->inst 
                                                >> 0x14U)))))),21);
    bufp->chgSData(oldp+64,(((0x1000U & (vlSelf->inst 
                                         >> 0x13U)) 
                             | ((0x800U & (vlSelf->inst 
                                           << 4U)) 
                                | ((0x7e0U & (vlSelf->inst 

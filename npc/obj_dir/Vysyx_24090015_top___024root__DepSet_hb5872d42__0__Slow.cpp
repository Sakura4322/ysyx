...
VL_ATTR_COLD void Vysyx_24090015_top___024root___eval_initial(Vysyx_24090015_top___024root* vlSelf) {
    ...
    vlSelf->__Vtrigrprev__TOP__ysyx_24090015_top__DOT__idu0__DOT__inst_type 
    ...
    vlSelf->__Vtrigrprev__TOP__ysyx_24090015_top__DOT__pwen 
        = vlSelf->ysyx_24090015_top__DOT__pwen;
    vlSelf->__Vtrigrprev__TOP__ysyx_24090015_top__DOT__valid 
...
#endif
                VL_FATAL_MT("/home/sakura/ysyx-workbench/npc/vsrc/top.v", 383, "", "Settle region did not converge.");
            }
...
VL_ATTR_COLD void Vysyx_24090015_top___024root___dump_triggers__act(Vysyx_24090015_top___024root* vlSelf) {
    ...
    if (vlSelf->__VactTriggered.at(0U)) {
        VL_DBG_MSGF("         'act' region trigger index 0 is active: @([changed] ysyx_24090015_top.idu0.inst_type)\n");
    }
    if (vlSelf->__VactTriggered.at(1U)) {
        VL_DBG_MSGF("         'act' region trigger index 1 is active: @(posedge clk)\n");
    }
    if (vlSelf->__VactTriggered.at(2U)) {
        VL_DBG_MSGF("         'act' region trigger index 2 is active: @([changed] ysyx_24090015_top.pmem_raddr or [changed] ysyx_24090015_top.pmem_waddr or [changed] ysyx_24090015_top.pmem_wdata or [changed] ysyx_24090015_top.pwen or [changed] ysyx_24090015_top.valid or [changed] ysyx_24090015_top.wmask)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vysyx_24090015_top___024root___dump_triggers__nba(Vysyx_24090015_top___024root* vlSelf) {
    ...
    if (vlSelf->__VnbaTriggered.at(0U)) {
        VL_DBG_MSGF("         'nba' region trigger index 0 is active: @([changed] ysyx_24090015_top.idu0.inst_type)\n");
    }
    if (vlSelf->__VnbaTriggered.at(1U)) {
        VL_DBG_MSGF("         'nba' region trigger index 1 is active: @(posedge clk)\n");
    }
    if (vlSelf->__VnbaTriggered.at(2U)) {
        VL_DBG_MSGF("         'nba' region trigger index 2 is active: @([changed] ysyx_24090015_top.pmem_raddr or [changed] ysyx_24090015_top.pmem_waddr or [changed] ysyx_24090015_top.pmem_wdata or [changed] ysyx_24090015_top.pwen or [changed] ysyx_24090015_top.valid or [changed] ysyx_24090015_top.wmask)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vysyx_24090015_top___024root___ctor_var_reset(Vysyx_24090015_top___024root* vlSelf) {
    ...
    vlSelf->__Vtrigrprev__TOP__ysyx_24090015_top__DOT__idu0__DOT__inst_type = VL_RAND_RESET_I(4);
    ...
    vlSelf->__Vtrigrprev__TOP__ysyx_24090015_top__DOT__pwen = VL_RAND_RESET_I(1);
    vlSelf->__Vtrigrprev__TOP__ysyx_24090015_top__DOT__valid = VL_RAND_RESET_I(1);

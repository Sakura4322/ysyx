...
VL_ATTR_COLD void Vysyx_24090015_top___024root__trace_init_sub__TOP__0(Vysyx_24090015_top___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+64,"init", false,-1, 20,0);
    tracep->pushNamePrefix("s1 ");
    tracep->declBus(c+69,"DATA_WIDTH", false,-1, 31,0);
    tracep->declBus(c+66,"WIDTH", false,-1, 31,0);
    tracep->declBus(c+64,"in", false,-1, 20,0);
    ...
    tracep->declBus(c+66,"WIDTH", false,-1, 31,0);
    tracep->declBus(c+55,"inst_in", false,-1, 31,0);
    tracep->declBus(c+62,"immB", false,-1, 31,0);
    tracep->declBus(c+65,"init", false,-1, 12,0);
    tracep->pushNamePrefix("s1 ");
    tracep->declBus(c+70,"DATA_WIDTH", false,-1, 31,0);
    tracep->declBus(c+66,"WIDTH", false,-1, 31,0);
    tracep->declBus(c+65,"in", false,-1, 12,0);
    ...
    tracep->declBit(c+71,"wmask", false,-1);
    tracep->popNamePrefix(1);
...
VL_ATTR_COLD void Vysyx_24090015_top___024root__trace_full_sub_0(Vysyx_24090015_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
                                           ...
                                           | ((0x800U 
                                              ...
                                              | ((0x7e0U 
                                                 ...
                                                 | (0x1eU 
                                                    & (vlSelf->inst 
                                                       >> 7U))))))),32);
    bufp->fullSData(oldp+63,((vlSelf->inst >> 0x14U)),12);
    bufp->fullIData(oldp+64,(((0x100000U & (vlSelf->inst 
                                            >> 0xbU)) 
                              | ((0xff000U & vlSelf->inst) 
                                 | ((0x800U & (vlSelf->inst 
                                    ...
                                    | (0x7feU & (vlSelf->inst 
                                                 >> 0x14U)))))),21);
    bufp->fullSData(oldp+65,(((0x1000U & (vlSelf->inst 
                                          >> 0x13U)) 
                              | ((0x800U & (vlSelf->inst 
                                            << 4U)) 
                                 | ((0x7e0U & (vlSelf->inst 
    ...
    bufp->fullBit(oldp+67,(vlSelf->ysyx_24090015_top__DOT__idu0__DOT__i0__DOT__clk));
    bufp->fullIData(oldp+68,(0xcU),32);
    bufp->fullIData(oldp+69,(0x15U),32);
    bufp->fullIData(oldp+70,(0xdU),32);
    bufp->fullBit(oldp+71,(vlSelf->ysyx_24090015_top__DOT__pmem0__DOT__wmask));

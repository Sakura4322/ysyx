...
VL_ATTR_COLD void Vysyx_24090015_top___024root__trace_init_sub__TOP__0(Vysyx_24090015_top___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+44,"pc", false,-1, 31,0);
    tracep->declBit(c+45,"flag", false,-1);
    tracep->declBus(c+46,"npc_pc", false,-1, 31,0);
    tracep->declBus(c+47,"npc_snpc", false,-1, 31,0);
    tracep->declBus(c+48,"npc_dnpc", false,-1, 31,0);
    ...
    tracep->declBus(c+56,"init", false,-1, 19,0);
    tracep->pushNamePrefix("s1 ");
    tracep->declBus(c+59,"DATA_WIDTH", false,-1, 31,0);
    tracep->declBus(c+57,"WIDTH", false,-1, 31,0);
    tracep->declBus(c+56,"in", false,-1, 19,0);
    ...
    tracep->declBus(c+46,"npc_pc", false,-1, 31,0);
    tracep->declBus(c+47,"npc_snpc", false,-1, 31,0);
    tracep->declBus(c+60,"npc_dnpc", false,-1, 31,0);
    tracep->popNamePrefix(1);
...
VL_ATTR_COLD void Vysyx_24090015_top___024root__trace_full_sub_0(Vysyx_24090015_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+46,((vlSelf->pc << 2U)),32);
    bufp->fullIData(oldp+47,(((IData)(4U) + (vlSelf->pc 
                                             << 2U))),32);
    bufp->fullIData(oldp+48,(vlSelf->ysyx_24090015_top__DOT__npc_dnpc),32);
    bufp->fullIData(oldp+49,(vlSelf->ysyx_24090015_top__DOT__src1),32);
    bufp->fullIData(oldp+50,(((- (IData)((IData)(vlSelf->ysyx_24090015_top__DOT__ren2))) 
    ...
    bufp->fullIData(oldp+56,(((0x80000U & (vlSelf->inst 
                                           >> 0xcU)) 
    ...
    bufp->fullIData(oldp+60,(vlSelf->ysyx_24090015_top__DOT__ifu0__DOT__npc_dnpc),32);

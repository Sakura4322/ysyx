...
VL_ATTR_COLD void Vysyx_24090015_top___024root__trace_init_sub__TOP__0(Vysyx_24090015_top___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+67,"init", false,-1, 20,0);
    tracep->pushNamePrefix("s1 ");
    tracep->declBus(c+72,"DATA_WIDTH", false,-1, 31,0);
    tracep->declBus(c+70,"WIDTH", false,-1, 31,0);
    tracep->declBus(c+68,"in", false,-1, 11,0);
    ...
    tracep->declBus(c+69,"init", false,-1, 12,0);
    tracep->pushNamePrefix("s1 ");
    tracep->declBus(c+74,"DATA_WIDTH", false,-1, 31,0);
    tracep->declBus(c+70,"WIDTH", false,-1, 31,0);
    tracep->declBus(c+69,"in", false,-1, 12,0);
    ...
    bufp->fullIData(oldp+66,(((0x100000U & (vlSelf->inst 
                              ...
                              | ((0xff000U & vlSelf->inst) 
                                 | ((0x800U & (vlSelf->inst 
                                    ...
                                    | (0x7feU & (vlSelf->inst 
                                                 >> 0x14U)))))),21);
    bufp->fullIData(oldp+67,(((0xfe0U & (vlSelf->inst 
                                         >> 0x14U)) 
                              | (0x1fU & (vlSelf->inst 
                                          >> 7U)))),21);
    bufp->fullSData(oldp+68,(((0xfe0U & (vlSelf->inst 
                                         >> 0x14U)) 
                              | (0x1fU & (vlSelf->inst 
                                          >> 7U)))),12);
    bufp->fullSData(oldp+69,(((0x1000U & (vlSelf->inst 
                                          >> 0x13U)) 
                              | ((0x800U & (vlSelf->inst 
                                            << 4U)) 
                                 | ((0x7e0U & (vlSelf->inst 

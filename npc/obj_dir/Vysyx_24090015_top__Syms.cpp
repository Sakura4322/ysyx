    ...
    , TOP____024unit{this, Verilated::catName(namep, "$unit")}
{
    ...
    // Setup scopes
    __Vscope_ysyx_24090015_top__csr_regfiles_instance.configure(this, name(), "ysyx_24090015_top.csr_regfiles_instance", "csr_regfiles_instance", -9, VerilatedScope::SCOPE_OTHER);
    __Vscope_ysyx_24090015_top__reg0.configure(this, name(), "ysyx_24090015_top.reg0", "reg0", -9, VerilatedScope::SCOPE_OTHER);
    // Setup export functions
    for (int __Vfinal = 0; __Vfinal < 2; ++__Vfinal) {
        __Vscope_ysyx_24090015_top__csr_regfiles_instance.exportInsert(__Vfinal, "read_wire", (void*)(&Vysyx_24090015_top___024root____Vdpiexp_ysyx_24090015_top__DOT__csr_regfiles_instance__DOT__read_wire_TOP));
        __Vscope_ysyx_24090015_top__reg0.exportInsert(__Vfinal, "read_wire", (void*)(&Vysyx_24090015_top___024root____Vdpiexp_ysyx_24090015_top__DOT__reg0__DOT__read_wire_TOP));
    }
}

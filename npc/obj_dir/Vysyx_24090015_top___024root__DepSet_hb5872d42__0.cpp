...
VL_INLINE_OPT void Vysyx_24090015_top___024root___nba_sequent__TOP__0(Vysyx_24090015_top___024root* vlSelf) {
    ...
    if (VL_UNLIKELY(vlSelf->flag)) {
        ...
        VL_FINISH_MT("/home/sakura/ysyx-workbench/npc/vsrc/top.v", 132, "");
    }
}
...
#endif
                VL_FATAL_MT("/home/sakura/ysyx-workbench/npc/vsrc/top.v", 120, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("/home/sakura/ysyx-workbench/npc/vsrc/top.v", 120, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("/home/sakura/ysyx-workbench/npc/vsrc/top.v", 120, "", "NBA region did not converge.");
            }
